...
export const theGraphStakingUrl = 'https://api.thegraph.com/subgraphs/name/hoprnet/stake-season6'
export const PROGRAM_START = 1674738000;  //Season 6
export const PROGRAM_END = 1682510400;  //Season 6

export const PROGRAM_START_MS = PROGRAM_START * 1000;  //Season 6
export const PROGRAM_END_MS = PROGRAM_END * 1000;  //Season 6
