...
export const theDecentralisedGraphStakingUrl = `https://gateway.thegraph.com/api/${process.env.DECENTRALIZED_SUBGRAPH_KEY}/subgraphs/id/C7cu6NvvMxgjdaK9pKSGezZ3EgRCmM4tWrmTtGUDG15t` //Season 6
export const theCentralisedGraphStakingUrl = `https://api.thegraph.com/subgraphs/name/hoprnet/stake-season6` //Season 6
